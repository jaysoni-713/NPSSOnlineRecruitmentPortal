...
; (function ($, undefined) {
    ...
    function renderPagination(wizard, options, state) {
        if (options.enablePagination) {
            var pagination = "<{0} class=\"actions {1}\"><ul role=\"menu\" aria-label=\"{2}\">{3}</ul></{0}>",
                ...
                finishbuttonTemplate = "<li><a href=\"#{0}\" id='{2}' onClick='{3}' role=\"menuitem\">{1}</a></li>"
            buttons = "";

            if (!options.forceMoveForward) {
                buttons += buttonTemplate.format("previous", options.labels.previous, "btnprev");
            }
            ...
            if (options.enableCancelButton) {
                buttons += buttonTemplate.format("cancel", options.labels.cancel, "btncancel");
            }
    ...
    function renderTitle(wizard, options, state, header, index) {
        var uniqueId = getUniqueId(wizard),
            ...
            stepItem = $("<li class='done' role=\"tab\"><a id=\"" + uniqueStepId + "\" href=\"#" + uniqueHeaderId +
